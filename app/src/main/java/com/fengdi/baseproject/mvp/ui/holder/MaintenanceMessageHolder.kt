...
class MaintenanceMessageHolder(itemView: View) : BaseHolder<MaintenanceMeassageBean>(itemView) {
    ...
    override fun setData(data: MaintenanceMeassageBean, position: Int) {
