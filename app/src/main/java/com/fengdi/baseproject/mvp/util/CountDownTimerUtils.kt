package com.fengdi.baseproject.mvp.util
 ...
 */(//显示倒计时的文字
    ...
    override fun onTick(millisUntilFinished: Long) {
        ...
        //设置倒计时时间
        mTextView.text = mTextView.resources.getString(R.string.str_resend, (millisUntilFinished / 1000).toString())
        mTextView.setTextColor(mTextView.resources.getColor(R.color.c_cccccc))
    }

    override fun onFinish() {
        mTextView.setText(R.string.str_get_smscode)
        mTextView.isClickable = true //重新获得点击
        mTextView.setTextColor(mTextView.resources.getColor(R.color.c_333333))
    }
