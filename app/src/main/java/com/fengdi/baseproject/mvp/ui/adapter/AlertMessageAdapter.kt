 ...
 *
*/
class AlertMessageAdapter(locks: List<AlertMessageBean>) : DefaultAdapter<AlertMessageBean>(locks) {


    /**
     * 获取设置Holder
     */
    override fun getHolder(v: View, viewType: Int): BaseHolder<AlertMessageBean> {
        return AlertMessageHolder(v)
    }
    ...
    override fun getLayoutId(viewType: Int): Int {
        return R.layout.item_alert_message
    }
