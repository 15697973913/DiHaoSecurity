 ...
 * ================================================
 */
public class ArmsPermissionUtil {
    public static final String TAG = "Permission";

    private ArmsPermissionUtil() {
    ...
    public static void externalStorage(RequestPermission requestPermission, RxPermissions rxPermissions, RxErrorHandler errorHandler) {
        requestPermission(requestPermission, rxPermissions, errorHandler, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE);
    }
